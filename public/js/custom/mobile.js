...
OMS.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    $stateProvider
        .state('home', {
            url: '/',
            templateUrl: 'template/mobile/home.html'
        })
        .state('auth', {
            abstract: true,
            url: '/auth',
            templateUrl: 'template/mobile/base.html'
        })
        .state('auth.signin', {
            url: '/signin',
            templateUrl: 'template/mobile/auth/signin.html',
            controller: 'signinController'
        })
        .state('auth.signup', {
            url: '/signup',
            templateUrl: 'template/mobile/auth/signup.html',
        ...
        .state('group.list_and_create', {
            url: '/list_and_create',
            templateUrl: 'template/mobile/group/list_and_create.html',
        ...
        .state('order.request', {
            url: '/request',
            templateUrl: 'template/mobile/order/request.html',
            controller: 'orderRequestController'
        })
        .state('order.confirm', {
            url: '/confirm',
            templateUrl: 'template/mobile/order/confirm.html',
            controller: 'orderConfirmController'
        })
        .state('order.list', {
            url: '/list',
            templateUrl: 'template/mobile/order/list.html',
        ...
        .state('statistics.waiting', {
            url: '/statistics',
            templateUrl: 'template/mobile/statistics/waiting.html',
        ...
        .state('manage.member', {
            url: '/member',
            templateUrl: 'template/mobile/manage/member.html',
            controller: 'manageMemberController'
        })
        .state('manage.menu', {
            url: '/confirm',
            templateUrl: 'template/mobile/manage/menu.html',
            controller: 'manageMenuController'
        })
        .state('manage.setmenu', {
            url: '/list',
            templateUrl: 'template/mobile/manage/setmenu.html',
